...
static inline void LLtoUTM(const double Lat, const double Long, 
                           double &UTMNorthing, double &UTMEasting,
                           int &UTMZoneNum, char &UTMZoneChar)
{
	double a = WGS84_A;
	double eccSquared = UTM_E2;
	double k0 = UTM_K0;
    ...
    UTMZoneChar = UTMLetterDesignator(Lat);
	eccPrimeSquared = (eccSquared)/(1-eccSquared);
                           ...
                           const char* UTMZone, double& Lat,  double& Long )
{
	...
	if((*ZoneLetter - 'N') < 0)
        ...
        //+3 puts origin in middle of zone
	LongOrigin = (ZoneNumber - 1)*6 - 180 + 3;
    printf("ZoneNumber = %d, ZoneLetter = %c\r\n", ZoneNumber, *ZoneLetter);
	eccPrimeSquared = (eccSquared)/(1-eccSquared);
...
static inline void UTMtoLL(const double UTMNorthing, const double UTMEasting,
                           const char UTMZoneNum, const char UTMZoneChar, double& Lat,  double& Long )
{
	double k0 = UTM_K0;
	double a = WGS84_A;
	double eccSquared = UTM_E2;
